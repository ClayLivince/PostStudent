...
public class VPNManager extends SiteManager {
    ...
    public static String vpnURL = "https://webvpn.bupt.edu.cn";
    ...
    private LoginStatus loginWithMap(Map<String, String> details) throws IOException {
        ...
        Log.e("wwwwww", login.body());

        if (login.contentType().contains("json")) {
            try {
                JSONObject loginObj = new JSONObject(login.body());
