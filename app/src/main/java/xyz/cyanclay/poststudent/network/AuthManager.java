...
public class AuthManager extends SiteManager {
    ...
    public static final String loginURL = "https://auth.bupt.edu.cn/authserver/login";
    ...
    public LoginStatus checkLogin(String service) throws Exception {
    ...
    public Connection.Response getAuth(String service) throws Exception {
        String url = loginURL + "?service=" + getEncodedURL(service);
        Connection.Response authInit = get(url);
        //String authInitURL = authInit.url().toString();
        cookies.putAll(authInit.cookies());
        return authInit;
    }
