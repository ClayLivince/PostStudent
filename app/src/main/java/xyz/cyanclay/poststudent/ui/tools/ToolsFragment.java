package xyz.cyanclay.poststudent.ui.tools;
...
public class ToolsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        root.findViewById(R.id.imageViewIClass).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                gotoIClass();
            }
    ...
    void gotoIClass() {
        Navigation.findNavController(this.requireActivity(), R.id.nav_host_fragment)
                .navigate(R.id.action_to_nav_iclass_main);
    }
}